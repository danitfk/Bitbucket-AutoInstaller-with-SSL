...
echo "1) Installing system requirements and download sources..." && $(tput setaf 3) requirements_install > /dev/null && echo "$(tput setaf 2)1) System Requirements installed successfully. $(tput sgr 0)"
